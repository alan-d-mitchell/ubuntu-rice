        ...
        match c {
            ...
            '%' => {
                if self.match_char('=') {
                    ...
                    Ok(Some((TokenType::FloatFormatter, "%d".to_string())))
                }
                else if self.match_char('c') {
                    Ok(Some((TokenType::CharFormatter, "%d".to_string())))
                }
                else if self.match_char('s') {
                    Ok(Some((TokenType::StringFormatter, "%d".to_string())))
                }
                else if self.match_char('b') {
                    Ok(Some((TokenType::BoolFormatter, "%d".to_string())))
                }
                else {

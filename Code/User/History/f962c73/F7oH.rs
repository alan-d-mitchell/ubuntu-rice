...
fn main() {
    ...
    let bishop_board = 0x0000_0000_0000_0040; // Bishop on c1 (square 2)
    ...
    let possible_bishop_moves = bishop_moves(bishop_board, occupied);
    bishops::print_bitboard(possible_bishop_moves);
}
